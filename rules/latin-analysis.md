---
description: Latin Word Analysis (JSON Specification)
triggers: ["latin", "word", "analyze", "parse", "declension", "conjugation", "lemma", "whitaker"]
outputFormat: json
toolRequirements: ["analyze_latin"]
---
...
-   **part_of_speech** --- one of:
    -   *verb*, *noun*, *adjective*, *adverb*, *pronoun*, *preposition*,
        ...
        *particle*, etc.
-   **translations** (object):
    -   **en**: short English meaning(s), prefer two to three words 
