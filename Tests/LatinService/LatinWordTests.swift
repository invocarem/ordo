...
final class LatinWordTests: XCTestCase
{
  ...
  func testAnalyzeLevo()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["levo"]
    else
    {
    ...
    XCTAssertTrue(
      translationContainsLift || translationContainsRaise,
  ...
  func testAnalyzeIntendo()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["intendo"]
    else
    {
    ...
    XCTAssertTrue(
      translationContainsDirect || translationContainsAim || translationContainsStretch || translationContainsIntend,
  ...
  func testRespicio()
  {
    ...
    for (key, values) in forms.sorted(by: { $0.key < $1.key })
    {
  ...
  func assertInimicusForms(from analysis: PsalmAnalysisResult)
  {
    ...
    guard let inimicusInfo = analysis.dictionary["inimicus"]
    else
    {
      XCTFail("""
  ...
  func testAnalyzeAdolescens()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["adolescens"]
    else
    {
  ...
  func testAnalyzeCustodio()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["custodio"]
    else
    {
  ...
  func testAnalyzeEgo()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["ego"]
    else
    {
  ...
  func testAnalyzeNos()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["nos"]
    else
    {
  ...
  func testAnalyzeQuis()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["quis"]
    else
    {
  ...
  func testAnalyzeIustusAndIustitia()
  {
    ...
    guard let iustusEntry = analysis.dictionary["iustus"]
    else
    {
    ...
    guard let iustitiaEntry = analysis.dictionary["iustitia"]
    else
    {
  ...
  func testAnalyzeEripio()
  {
    ...
    // Verify lemma exists
    guard let entry = analysis.dictionary["eripio"]
    else
    {
    ...
    XCTAssertTrue(
      translationContainsRescue || translationContainsDeliver || translationContainsSnatch,
