...
class Psalm105ATests: XCTestCase {
    ...
    private let text = [
        ...
        "et deduxit eos in abyssis sicut in deserto. Et salvavit eos de manu odientium,",
        ...
        "non crediderunt verbo eius. Et murmuraverunt in tabernaculis suis,",
    ...
    private let englishText = [
        ...
        "And he led them through the depths, as in a wilderness. And he saved them from the hand of them that hated them,",
        ...
        "They believed not his word, and they murmured in their tents:",
    ...
    // ------------------------------------------------------------------------
    private let structuralThemes: [(String, String, [String], Int, Int, String)] = []
