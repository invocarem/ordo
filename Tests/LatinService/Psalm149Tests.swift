...
class Psalm149Tests: XCTestCase {
  ...
  let id = PsalmIdentity(number: 149, category: "")
  ...
  private let structuralThemes = [
    (
      ...
      ["canto", "canticum", "novus", "laus", "ecclesia", "sanctus", "laetor", "israel", "facio", "sion", "exsulto", "rex"],
      1,
      2,
    ...
    (
      ...
      ["laudo", "nomen", "chorus", "tympanum", "psalterium", "psallo", "beneplacitum", "dominus", "populus", "exalto", "mansuetus", "salus"],
      3,
      4,
    ...
    (
      ...
      ["exsulto", "sanctus", "gloria", "laetor", "cubile", "exaltatio", "deus", "guttur", "gladius", "anceps", "manus"],
      5,
      6,
    ...
    (
      ...
      ["facio", "vindicta", "natio", "increpatio", "populus", "alligo", "rex", "compedes", "nobilis", "manicae", "ferreus"],
      7,
      8,
  ...
  func testTotalVerses() {
    XCTAssertEqual(
      text.count, expectedVerseCount, "Psalm 149 should have \(expectedVerseCount) verses"
    )
    XCTAssertEqual(
      englishText.count, expectedVerseCount,
      "Psalm 149 English text should have \(expectedVerseCount) verses"
    )
  ...
  func testSaveTexts() {
    ...
    let success = utilities.saveToFile(
      content: jsonString,
      filename: "output_psalm149_texts.json"
    )
